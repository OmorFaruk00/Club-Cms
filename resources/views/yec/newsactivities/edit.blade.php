                ...
                <div class="card card-shadow">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('yec.news_activities') }}" style="margin-right: 10px"> <img src="/image/list.png"
                                    alt="" height="25px"> </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" v-model="type" class="form-control" required>
                                            ...
                                            <option v-for="(row,index) in types" :key="index"
                                                :value="row.value" v-html="row.text"></option>
                                        </select>
                                    </div>
                                </div>
            ...
            var vue = new Vue({
                ...
                methods: {
                    ...
                    storeData() {
                        ...
                        formData.append('web', 'yec');
                        formData.append("file", document.getElementById('file_input').files[0]);

                        axios.post(`${this.config.base_path}/news_activities/${this.id}?token=${token}`,
                            formData, {
                                headers: {
