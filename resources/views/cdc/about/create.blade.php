                ...
                <div class="card card-shadow">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h5 class="mt-2"> About Create </h5>
                            <a href="{{ route('cdc.about') }}" style="margin-right: 10px"> <img src="/image/list.png"
                                    alt="" height="25px"> </a>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            var vue = new Vue({
                ...
                methods: {
                    ...
                    storeData() {
                        ...
                        axios.post(`${this.config.base_path}/about?token=${token}`, formData, {
                            headers: {
