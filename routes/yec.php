...
use App\Http\Controllers\YEC\TeamController;
use App\Http\Controllers\YEC\AboutController;
use App\Http\Controllers\YEC\EventController;
use App\Http\Controllers\YEC\SliderController;
use App\Http\Controllers\YEC\NewsActivitiesController;
...
Route::group(['middleware' => ['logged_in']], function () {   
    Route::prefix('yec')->as('yec.')->group(function () {
        Route::view('/dashboard','yec.dashboard')->name('dashboard');     
